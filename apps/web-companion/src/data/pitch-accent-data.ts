...
export const pitchAccentData: PitchAccentEntry[] = [
  { word: '日本', reading: 'にほん', definition: 'Japan', partOfSpeech: 'Noun', moraCount: 3, pitchPattern: 'Heiban', sequence: ['L', 'H', 'H'] },
  { word: '東京', reading: 'とうきょう', definition: 'Tokyo', partOfSpeech: 'Noun', moraCount: 4, pitchPattern: 'Heiban', sequence: ['L', 'H', 'H', 'H'] },
  { word: '日本語', reading: 'にほんご', definition: 'Japanese language', partOfSpeech: 'Noun', moraCount: 4, pitchPattern: 'Heiban', sequence: ['L', 'H', 'H', 'H'] },
  { word: '勉強', reading: 'べんきょう', definition: 'study', partOfSpeech: 'Noun', moraCount: 4, pitchPattern: 'Heiban', sequence: ['L', 'H', 'H', 'H'] },
  { word: '食べる', reading: 'たべる', definition: 'to eat', partOfSpeech: 'Verb', moraCount: 3, pitchPattern: 'Nakadaka', sequence: ['L', 'H', 'L'] },
  ...
  { word: '先生', reading: 'せんせい', definition: 'teacher', partOfSpeech: 'Noun', moraCount: 4, pitchPattern: 'Heiban', sequence: ['L', 'H', 'H', 'H'] },
  { word: '学生', reading: 'がくせい', definition: 'student', partOfSpeech: 'Noun', moraCount: 4, pitchPattern: 'Heiban', sequence: ['L', 'H', 'H', 'H'] },
  ...
  { word: '天気予報', reading: 'てんきよほう', definition: 'weather forecast', partOfSpeech: 'Noun', moraCount: 6, pitchPattern: 'Heiban', sequence: ['L', 'H', 'H', 'H', 'H', 'H'] },
  ...
  { word: '会社', reading: 'かいしゃ', definition: 'company', partOfSpeech: 'Noun', moraCount: 4, pitchPattern: 'Heiban', sequence: ['L', 'H', 'H', 'H'] },
  { word: '病院', reading: 'びょういん', definition: 'hospital', partOfSpeech: 'Noun', moraCount: 4, pitchPattern: 'Heiban', sequence: ['L', 'H', 'H', 'H'] },
